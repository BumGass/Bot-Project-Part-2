    ...
    if (user.presence.game.name === 'Spotify' && user.presence.game.type === 2) {
        try {
            ...
            const embed = new Discord.RichEmbed()
                ...
                .setFooter(`Mowa Bot Spotify Sistemi'nden, ${message.author.username} tarafından istendi.`, "https://cdn.discordapp.com/emojis/515260605347659777.png?v=1")
                .setDescription(`
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['spo', 'spoti', 'soti', 'spotif', 'spotify', 'spotifi'],
  permLevel: 0
};

exports.help = {
  name: 'spotify',
  description: 'Etiketlediğiniz Kişinin Spotify Üzerinde Dinlediği Şarkının Bilgilerini Verir.',
  usage: 'spotify'
};
