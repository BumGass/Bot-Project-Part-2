...
exports.run = (client, message, args) => {
    ...
    if (!game) return message.reply('Lütfen Steamde Olan Bir Oyunun Adını Yazın. Örnek: `m_steamfiyat PUBG`')
...
İndirimli Fiyat **${results.priceData.finalPrice}** TL`, true)
  ...
  .setColor(message.guild.me.displayColor)
    .setFooter(message.author.username + `, için ${result[0].name} Oyununun Bilgileri`, message.author.avatarURL)
